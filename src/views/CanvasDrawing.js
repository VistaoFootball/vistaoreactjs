	...
	return (
		<div>
	  		<div style={{ position: "fixed", zIndex:"1" }}>
				...
				<button style={{ backgroundColor: "#0000ff"}} onClick={() => setColor("blue")}>Blue</button>
				<button style={{ backgroundColor: "#ff0000"}} onClick={() => setColor("red")}>Red</button>
				<button style={{ backgroundColor: "#00ff00"}} onClick={() => setColor("green")}>Green</button>
				<button style={{ backgroundColor: "#ffff00"}} onClick={() => setColor("yellow")}>Yellow</button>
	  		</div>
      ...
      <div>
	  		...
	  		<canvas style={{ position: "absolute", width:"100%", height:"100%",  bottom: 0, left: 0, right: 0}}
				id="canvas"
